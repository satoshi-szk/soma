...
export const pywebviewApi = {
  ...
  list_recent_projects: () => callApi('list_recent_projects'),
  open_project: () => callApi('open_project'),
  open_project_path: (payload: PayloadFor<'open_project_path'>) => callApi('open_project_path', payload),
  ...
  start_harmonic_probe: (payload: PayloadFor<'start_harmonic_probe'>) => callApi('start_harmonic_probe', payload),
  update_harmonic_probe: (payload: PayloadFor<'update_harmonic_probe'>) => callApi('update_harmonic_probe', payload),
  stop_harmonic_probe: () => callApi('stop_harmonic_probe'),
  pause: () => callApi('pause'),
  stop: (payload: PayloadFor<'stop'>) => callApi('stop', payload),
  set_master_volume: (payload: PayloadFor<'set_master_volume'>) => callApi('set_master_volume', payload),
  update_playback_mix: (payload: PayloadFor<'update_playback_mix'>) => callApi('update_playback_mix', payload),
  list_midi_outputs: () => callApi('list_midi_outputs'),
  update_playback_settings: (payload: PayloadFor<'update_playback_settings'>) => callApi('update_playback_settings', payload),
